...
let setData = (day) =>{
    ...
    let daylist = ["Неділя", "Понеділок", "Вівторок", "Середа", "Четверг", "Пятниця", "Субота"]
...
function timeTableAll(){
    ...
    setData(today);
    document.querySelector('.timetable div h2').innerHTML = "Сьогоднішній розклад";
}
...
document.querySelector('.timetable div h2').innerHTML = "Сьогоднішній розклад"; //To prevent overwriting the heading on loading;
